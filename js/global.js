...
var widgetsToReload = [];
var widgetsList = {};
var imgLoad = $('<img />', { src : '/img/tw-gif.gif' });
var loadingIcon = null;
var loadingDiv = null;
var placeholder = "img/client.png";
var loadingCounter = 0;
var imgLoadSpinner = $("<img /", { src : "/img/loading-spinner_.gif "});
var $TWBlockLoading = $('<div id="lodingBlock"><img id="loadingBlockImg" src="/img/loading-spinner_.gif"></div>');
...
function triggerLoading(target){
	...
	html =  '<div class="deleting loading loading'+loadingCounter+'">'+
                '<div class="loadingSignIcon"><img src="/img/tw-gif.gif"> </div>'+
...
var $blackSpinner = $('<img src="/img/loading-spinner_.gif">');
var $TWloading = $('<img src="/img/tw-gif.gif">');
