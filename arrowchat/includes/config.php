<?php 
	...
	*/
	if(isset($_SERVER) and strtolower($_SERVER["SERVER_NAME"]) == "trainerworkout.com"){
		define('DB_SERVER','localhost'); 
		define('DB_USERNAME','trainer_dev'); 
		define('DB_PASSWORD','Explore10'); 
		define('DB_NAME','trainer_trainerworkout');	
	} else if(isset($_SERVER) and strtolower($_SERVER["SERVER_NAME"]) == "staging.trainerworkout.com"){
		define('DB_SERVER','localhost'); 
		define('DB_USERNAME','trainer_dev'); 
		define('DB_PASSWORD','Explore10'); 
		define('DB_NAME','trainer_staging');	
	} else {
		define('DB_SERVER','localhost'); 
		define('DB_USERNAME','root'); 
		define('DB_PASSWORD','root'); 
		define('DB_NAME','trainerworkout');
	}
	...
	*/
	...
	define('DB_USERTABLE_NAME2','lastName'); 
	define('DB_USERTABLE_USERID','id'); 
	define('DB_USERTABLE_AVATAR','thumb'); 
	
	define('DB_FRIENDSTABLE','friends'); 
	define('DB_FRIENDSTABLE_USERID', 'followingId'); 
	define('DB_FRIENDSTABLE_FRIENDID', 'userId'); 
	//define('DB_FRIENDSTABLE_FRIENDS', 'chat');
