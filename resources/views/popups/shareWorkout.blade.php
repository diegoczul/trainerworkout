    ...
    <div class="popup_container sharewokoutform">
        ...
        <div class="share_content">
            ...
            <div class="input_container">
                ...
                <label for="personalizedTxt"
                    class="input_label">{{ Lang::get('content.Personalizethemessagetoyourclients') }}</label>
                <textarea name="personalizedTxt" id="personalizedTxt"
                    placeholder="{{ Lang::get('content.Thisisthemessagethatyourclientwillreceive') }}"></textarea>
                <div class="sharingOptions">
                    <div class="option"><input id="copyMe" type="checkbox" value="yes" name="copyMe"
                            checked="checked" /> <label for="copyMe">{{ Lang::get('content.sendCopy') }}</label></div>
                    <div class="option"><input id="copyPrint" type="checkbox" value="yes" name="copyPrint"
                            checked="checked" /> <label
                            for="copyPrint">{{ Lang::get('content.includePrintWorkout') }}</label> </div>
                    <div class="option"><input id="subscribe" type="checkbox" value="yes" name="subscribe"
                            checked="checked" /> <label
                            for="subscribeToWorkout">{{ Lang::get('content.subscribeToWorkout') }}</label> </div>
                    <div class="option"><input id="lock" type="checkbox" value="yes" name="lock"
                            checked="checked" /> <label for="lock">{{ Lang::get('content.lockWorkout') }}</label>
                    </div>
                </div>
