                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    {{  FORM::select("userType",array("Trainee"=>"Trainee","Trainer"=>"Trainer","Wait_Trainee"=>"Wait_Trainee","Wait_Trainer"=>"Wait_Trainer",),array("id"=>"userType","class"=>"chosen-select", "class"=>"form-control")) }}
                                </div>
                                <div class="form-group">
