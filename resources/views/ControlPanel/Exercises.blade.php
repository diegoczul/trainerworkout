                ...
                <div class="panel panel-body">
                    ...
                    <div class="form-group">
                        <label>Do not show exercise without Equipment!
                            <input type="checkbox"  name="equipmentRequired" id="equipmentRequired" value="Yes" class="noErase" onclick="this.value = 'Yes'"></label>
                    </div>
                    <div class="form-group">
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            arrayDataTables["dtExercises"] = dtExercises = $("#dtExercises").DataTable({
                ...
                columns: [
                    { title: "Thumbnail", searchable: false, data: "thumb", class: "text-center", render: function (data, type, row) { return imageRotate1Switch(data, row.id); } },
                    ...
                    { title: "Equipment", searchable: false, data: "equipments", render: function (data) { return data ? showNames(data) : ""; } },
                    { title: "Optional Equipment", searchable: false, data: "equipments_optional", render: function (data) { return data ? showNames(data) : ""; } },
            ...
            if(confirm("Are you sure?")){
                if($("#hiddenId").val() != ""){
                    ...
                    $.ajax({
                        ...
                        type: "POST",
                        data: { id:$("#hiddenId").val(),image:number },
                        success:function(data, textStatus, jqXHR){
                            if(number == 1){
                                $("#imageImage").attr("src","");
                            } else {
