...
<head>
  ...
  {{ HTML::style('css/printWorkout.css') }}
    ...
    <!-- Headers start -->
        ...
        <div class="header">
            ...
            @endif
             ...
             <div class="poweredby">
                ...
                <img src="{{ Config::get("app.logo_on_print_grid") }}">
             </div>
       ...
       <?php $dayProportion = (1 / $daysWorkout * 100) - 1; ?>
        ...
        ?>
            ...
            @if(count($exercises) > 1) <!-- IF this is a Circuit -->
            ...
            @foreach($exercises as $exercise)
                ...
                <div class="exercise_line">
                    ...
                    <div class="exTable">
                        ...
                        @if($exercise->exercises->bodygroupId != 18) <!-- if muscle exercise in circuit -->
                            <thead class="muscle"> <!-- Header of Muscle Exercise -->
                            <tr> 
                                <th scope="row" class="set">{{ Lang::get("content.Set") }}</th>

                                @for($x = 0; $x < $daysWorkout; $x++)
                                    <th scope="col" class="wgt firstColDay <?php echo"day$x"; ?> "><span>{{ Lang::get("content.Wgt") }}</span> @if($exercise->units == "Metric")<span>(kg)</span>@else<span>(lbs)</span>@endif</th>
                            ...
                            @for($y = 0; $y < $exercise->sets; $y++)
                                <tr>
                                    ...
                                    <?php $pointer = $exercise->sets*$x+$y; ?>
                                        ...
                                        <td class="rep lastColDay <?php echo"day$x"; ?>">{{ $setsTemp[$pointer]->time }} <span>sec</span></td>
                                            @else
                        ...
                        @else <!-- Not Muscle start Cardio Exercise in circuit -->
                            <?php 
                               $sets = $workout->getSets($exercise->id); 
                               $setsTemp = array();
                               $counter = 0;
                            ...
                            <tr>
                                ...
                                @for($x = 0; $x < $daysWorkout; $x++)
                                    <th scope="col" class="time firstColDay <?php echo"day$x"; ?>"><p>{{ Lang::get("content.Time") }}</p><p>({{ Lang::get("content.min") }})</p></th>
                                    <th scope="col" class="dist <?php echo"day$x"; ?>"><p>{{ Lang::get("content.Distance") }}</p><p>(<span class="exercise_units_speed_unit_{{ $exercise->id }}">{{ ($exercise->units == "Metric") ? Lang::get("content.km") : Lang::get("content.mi") }}</span>)</p></th>
                                    ...
                                    <th scope="col" class="speed lastColDay <?php echo"day$x"; ?>"><p>{{ Lang::get("content.Spd") }}</p><p>(<span class="exercise_units_speed_unit_{{ $exercise->id }}">{{ ($exercise->units == "Metric") ? Lang::get("content.km/h") : Lang::get("content.mi/h") }}</span>)</p></th>
                                @endfor
                            </tr> 
                            </thead>
                ...
                <div class="exTable">
                    <table class="setsTable">    
                        ...
                        <tr> 
                            ...
                            @for($x = 0; $x < $daysWorkout; $x++)
                                <th scope="col" class="wgt firstColDay <?php echo"day$x"; ?>">{{ Lang::get("content.Wgt") }}
          ...
          <!------------------------------------------------------Cardio------------------------------------------------------------------>  
            ...
            <div class="restBtwExe group">
                <svg width="27" height="27" viewBox="0 0 27 27" xmlns="https://www.w3.org/2000/svg">
                    ...
                    <g transform="translate(1 1)" fill="none" fill-rule="evenodd">
                        <circle stroke="#4A4A4A" fill="#FFF" cx="12.5" cy="12.5" r="12.5"/></circle>
                        <path fill="#4A4A4A" d="M7 6h4v13H7zM14 6h4v13h-4z"/></path>
                    </g>
                </svg>
