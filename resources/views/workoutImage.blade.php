                                ...
                                <div class="exercise_Header_btw">
                                    <div class="exercise_Header_container circuitInfo">
                                        ...
                                        @else
                                            <div class="nbrounds">
                                                <div class="circleInstruction">
                                                    <p class="roundsMeasure" style="color: #fff">{{{ $group->intervals }}}</p>
                                                    <span>rounds</span>
                                                </div>
                                            </div>
                                ...
                                <div class="exercise muscle" exercise="">
                                    <div class="exercise_Header">
                                        <div class="exercise_Header_imgContainer">
                                            @if(isset($exercise->equipmentId) && !empty($exercise->equipmentId))
                                                <img class="equip_img" onerror="this.src = '{{asset('assets/img/placeholder.jpg')}}'" src="{{ Helper::imageToBase64(public_path('/'.$exercise->equipment->thumb)) }}">
                                            @endif
                                        </div>
