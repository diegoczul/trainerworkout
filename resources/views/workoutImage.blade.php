            ...
            <div class="workoutHedaer">
                <div class="workoutHeaderImage">
                    <div class="one_sixth">
                        @if($workout->author and $workout->author->activeLogo)
                            <img width="85" src="/{{ Helper::image($workout->author->activeLogo->image) }}">
                        @endif
                    </div>
                    ...
                    <div class="one_sixth">
                        ...
                        <img src="{{ Config::get("app.logo_on_image") }}">                   
                    </div>
                </div>
                ...
                <div class="workoutData">
                    <div class="workoutPT">
                        ...
                        <img src="/{{ ($workout->author) ? Helper::image($workout->author->image) : Helper::image("")  }}">
