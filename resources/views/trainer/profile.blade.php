                ...
                <label class="profilePictureContainer" for="image">{{ Lang::get("content.ProfileImage") }}
                    <div class="img rotatingParent_bottom">
                        ...
                        <div class="editImgContainer">
                            <a href="javascript:void(0)" onClick="rotateLeft($(this)); arguments[0].stopPropagation(); return false;" class="rotate_left"><img src="{{asset('assets/img/rotate_left.png')}}"/></a>
