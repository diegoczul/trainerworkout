    ...
    <div class="widget">
        <div class="workouts">
            <div class="clientNavigation">
                <a href="/Trainer/Clients">{{ Lang::get("content.backToClients") }}</a>
            </div>
            <div class="workoutHeader">
                <div class="workoutHeader_description">
                    <h1>{{ Lang::get("content.WorkoutsOf") }} {{ ( $client->user and $client->user->getCompleteName() != "" ) ? $client->user->getCompleteName() :  ($client->user ? $client->user->email : "Client") }}</h1>
...
<div class="shareWorkoutslightBox" onclick="hidelightbox(event)";>
    <div class="popup_container sharewokoutform" >
        ...
        <div class="share_content">
            ...
            <div class="input_container">
                ...
                <input type="text" name="toemail" placeholder="email address">
                <label for="personalizedTxt" class="input_sub_label">{{ Lang::get("content.Personalizethemessagetoyourclients") }}</label>
...
function viewArchivedWorkouts(){
    ...
    callWidget("w_workoutsClient",null,{{  Auth::user()->id }},null,{ client:<?php echo $client->id; ?>,archive:'true' });
...
$("#shareWorkouts").click(function () {
    $(".shareWorkoutslightBox").addClass("shareWorkoutslightBox-activated");
...
/*function hidelightbox(e) {
    if (e.target == $('.shareWorkoutslightBox')[0]){
        $(".shareWorkoutslightBox").removeClass("shareWorkoutslightBox-activated");
