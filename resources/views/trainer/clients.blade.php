                    ...
                    <div class="workoutHeader">
                        ...
                        @if(Auth::user()->getNumberOfClients() > 0)
                            <div class="workouts_options clients_options workouts_options_down">
                                <a title="Delete" href="javascript:void(0)" class="moreOptionsButton"
                                   id="deleteWorkouts" onclick="deleteClients()">
                        ...
                        @endif
                        <a href="javascript:void(0)" class="addElementButton" id="createClient"
                           onclick="lightBox();">{{ Lang::get("content.NewClient") }}</a>
                    </div>
                    <div id="w_clients">
