...
<head>
    ...
    <noscript>
        <img height="1" width="1" alt="" style="display:none" src="https://www.facebook.com/tr?ev=6038068455680&amp;cd[value]=0.01&amp;cd[currency]=CAD&amp;noscript=1"/>
    </noscript>
        ...
        <div class="row">
            ...
            <div class="col-md-4 footer_col">
                ...
                <div class="resp-appear">
                    ...
                    <ul class="socials">
                        <li><a href=""><img src="{{asset('assets/img/socials/social_email.png')}}" alt="email"></a></li>
                        <li><a href=""><img src="{{asset('assets/img/socials/social_instagram.png')}}" alt="email"></a></li>
                        <li><a href=""><img src="{{asset('assets/img/socials/social_twitter.png')}}" alt="email"></a></li>
                        <li><a href=""><img src="{{asset('assets/img/socials/social_facebook.png')}}" alt="email"></a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="row">
            <form method="POST" action="https://trainerworkout.com/registerNewsletter" accept-charset="UTF-8" class="">
                <input name="_token" type="hidden" value="WP96IYz8k3m3x5rWBF5prcxnvGzhFrZRx1jPIJ67">
                <div class="col-xs-4 no_padding resp-100">
                    <input class="newsletter col-xs-12" type="text" placeholder="Newsletter Sign Up" name="email"/>
                </div>
                <div class="col-xs-4 no_padding resp-100">
            ...
            <div class="col-xs-4 no_padding resp-disapear">
                ...
                <ul class="socials">
                    <li>
                        <a href="mailto:info@trainerworkout.com">
                            <img src="{{asset('assets/img/socials/social_email.png')}}" alt="email" height="494" width="494">
                        </a>
                    </li>
                    <li>
                        <a href="https://instagram.com/TrainerWorkout/">
                            <img src="{{asset('assets/img/socials/social_instagram.png')}}" alt="email" height="494" width="494">
                        </a>
                    </li>
                    <li>
                        <a href="https://twitter.com/TrainerWorkout">
                            <img src="{{asset('assets/img/socials/social_twitter.png')}}" alt="email" height="512" width="512">
                        </a>
                    </li>
                    <li>
                        <a href="https://www.facebook.com/tworkout">
                            <img src="{{asset('assets/img/socials/social_facebook.png')}}" alt="email" height="530" width="512">
                        </a>
                    </li>
                </ul>
            </div>
