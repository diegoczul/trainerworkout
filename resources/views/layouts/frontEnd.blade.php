...
<head>
    ...
    <!-- Website Css -->
    <!-- Core style -->
    {!! HTML::style(asset('assets/css/website/style.css')) !!}
    ...
    {{--            }; --}}
    {{--            h._hjSettings = {hjid: 9600, hjsv: 5}; --}}
...
<body>
    ...
    <nav id="topNav" class="top">
        <div class="wrapper navRoot">
            ...
            <div class="nav_block primary">
                ...
                <a href="/Gym" class="nav_item nav_gym">{{ Lang::get('content.frontEnd/Gym') }}</a>
            ...
            <div class="mobile">
                ...
                <div class="mobileMenu" id="mobileMenu">
                    <div class="mobileMenuContent">
                        ...
                        <a href="/"
                            class="nav_item selected">{{ Lang::get('content.frontEnd/PersonalTrainer') }}</a>
                        <a href="/Gym" class="nav_item nav_gym">{{ Lang::get('content.frontEnd/Gym') }}</a>
                        <a href="/blog" class="nav_item">{{ Lang::get('content.frontEnd/Blog') }}</a>
                    ...
                    <div class="mobileMenuLogin">
                        ...
                        <a href="{{ Lang::get('routes./TrainerSignUp') }}"
                            class="nav_item signup">{{ Lang::get('content.Get started for free') }}</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <nav id="scrollNav" class="hide">
        <div class="wrapper navRoot">
            ...
            <div class="nav_block secondary">
                <a href="{{ Lang::get('routes./TrainerSignUp') }}"
                    class="action">{{ Lang::get('content.Get started for free') }}</a>
            </div>
            <div class="mobile">
                <svg class="level_one" width="40" height="31" viewBox="0 0 40 31" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <footer>
        <div class="wrapper footerContainer">
            ...
            <div class="footer_block pages">
                ...
                <div class="page gyms">
                    <h2><a href="/Gym">{{ Lang::get('content.frontEnd/Gym') }}</a></h2>
                    <!-- <a href="/Gym#primary">{{ Lang::get('content.frontEnd/Mobilefriendly') }}</a> -->
                    <a href="/Gym#secondary">{{ Lang::get('content.frontEnd/Footer/ExpClient') }}</a>
                    <a href="/Gym#third">{{ Lang::get('content.frontEnd/Footer/ptTools') }}</a>
                    <a href="/Gym#forth">{{ Lang::get('content.frontEnd/Footer/Control') }}</a>
                    <a href="/Gym#pricing">{{ Lang::get('content.frontEnd/PricingPlans') }}</a>
                </div>
            </div>
            <div class="breakLine"></div>
            ...
            <div class="footer_block social">
                <div class="socialBottom">
                    <a href="mailto:info@trainer-workout.com"><img
                            src="{{ asset('assets/img/socials/social_email.png') }}" alt="email"></a>
                    <a target="_blank" href="https://www.instagram.com/trainerworkout"><img
                            src="{{ asset('assets/img/socials/social_instagram.png') }}" alt="instagram"></a>
                    <a target="_blank" href="https://twitter.com/trainerworkout"><img
                            src="{{ asset('assets/img/socials/social_twitter.png') }}" alt="twitter"></a>
...
@if (!Config::get('app.debug'))
    ...
    <script>
        ...
        fbq('init', '400688060094236'); // Insert your pixel ID here.
        fbq('track', 'PageView');
    </script>
...
<?php $array = explode('?', request()->fullURL()); ?>

@if (count($array) > 1)
    <?php session()->put('utm', $array[1]); ?>
@endif
<script>
    //ALL AJAX FORMS SAVE
