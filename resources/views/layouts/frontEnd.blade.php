        ...
        <div class="mobile">
            ...
            <div class="mobileMenu" id="mobileMenu">
                <div class="mobileMenuContent">
                    <svg class="close--mobileMenu" width="25px" height="25px" viewBox="706 29 25 25" version="1.1"
...
<footer>
    <div class="wrapper footerContainer">
        ...
        <div class="footer_block newsletter">
            ...
            <form class="newsletter" method="POST" action="{{ Lang::get("routes./registerNewsletter") }}" accept-charset="UTF-8">
        ...
        <div class="footer_block social">
            <div class="socialBottom">
                <a href="mailto:info@trainerworkout.com"><img src="{{asset('assets/img/socials/social_email.png')}}" alt="email"></a>
                <a target="_blank" href="https://www.instagram.com/trainerworkout"><img src="{{asset('assets/img/socials/social_instagram.png')}}" alt="instagram"></a>
                <a target="_blank" href="https://twitter.com/trainerworkout"><img src="{{asset('assets/img/socials/social_twitter.png')}}" alt="twitter"></a>
                <a target="_blank" href="https://www.facebook.com/tworkout/"><img src="{{asset('assets/img/socials/social_facebook.png')}}" alt="facebook"></a>
            </div>
        </div>
...
@if(!Config::get("app.debug"))
    ...
    <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=400688060094236&ev=PageView&noscript=1" /></noscript>
    <!-- DO NOT MODIFY -->
