...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <style type="text/css">
            ...
            h1, h1 a{color:#2C3E50; font-size:44px; font-weight:100; line-height:115%; text-align:center;}
            h2, h2 a{color:#2C3E50; font-size:34px; font-weight:100; line-height:100%; text-align:left;}
            h3, h3 a{color:#2C3E50; font-size:30px; font-weight:100; line-height:115%; text-align:left;}
            h4, h4 a{color:#fff; font-size:26px; font-weight:100; line-height:115%; text-align:left;}
            p, p a{color: #2C3E50; font-size: 20px; font-weight: 200; line-height: 115%; text-align: justify;}
            ...
            #mainActionContainer{background-color:#369AD8; padding: 80px 40px;}
            .introMessage{text-align: left; padding-bottom: 40px;}
            .messageFromFriend{padding-bottom: 10px; font-style: italic; text-align: center;}
            .friendMessage{text-align: center; color:#2C3E50; font-weight: 300;  word-break: normal;}
            ...
            .actionButtonContent a{background:#FBB147; display: inline-block; border-radius:2px; color:#fff; padding:10px 18px; text-decoration: none; font-size: 18px; border-bottom: solid 2px #EB9561;}
                                ...
                                <table align="center id=" headerblock" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                                    <tr>
                                        <td style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                                            <img height="116" width="200" style="border: 0;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;" src="http://www.beta.trainerworkout.com/img/newsletter/tw_logo.png">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
