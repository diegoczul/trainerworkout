        ...
        <div class="max-w-2xl mx-auto bg-white p-6 rounded shadow">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="street" id="biStreet" value="{{ Auth::user()->street }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="city" id="biCity" value="{{ Auth::user()->city }}"
                            class="mt-1 block w-full rounded border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm" />
                    </div>
                    <div>
                        <label for="biPostCode" class="block text-sm font-medium text-gray-700">Postal Code</label>
                        <input type="text" name="postal" id="biPostCode" value="{{ Auth::user()->postalcode }}"
                            class="mt-1 block w-full rounded border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm" />
                    </div>
                </div>
