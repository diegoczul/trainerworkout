...
{{ Form::open(array('url' => Lang::get("routes./Store/ProcessPayment"),"id"=>"payment-form")); }}
    <div class="wrapper">
        <div class="checkoutBox payCard">
            ...
            <h1>{{ Lang::get("content.Payment") }}</h1>
              ...
              @endforeach
                  ...
                  <div class="payPlanBtn"><a href="{{ Lang::get("routes./UpgradePlan") }}">{{ Lang::get("content.changeplan") }}</a></div>
              </div>
        </div>
                        ...
                        <form action="/Store/ProcessPayment/" method="post" enctype="multipart/form-data" name="payform" id="payform" class="formholder clearfix">
                            ...
                            <div class="payFormFull">
                                <fieldset class="payForm payFormHalf">
                                    ...
                                    <input id="biCity" value="{{ Auth::user()->city }}" placeholder="New York City" name="city" type="text" class="payFormInput validate[required]">
                                </fieldset>


                                <fieldset class="payForm payFormHalf payFormRight">
                                    <label for="biPostCode">{{ Lang::get("content.postalcode") }}</label>
                                    <input id="biPostCode" value="{{ Auth::user()->postalcode }}" placeholder="23560" name="postal" type="text" class="payFormInput validate[required]">
                                </fieldset>
                            </div>
                            ...
                            <div class="payFormFull">
                              ...
                              <fieldset class="payForm payFormHalf payFormRight ">
                                ...
                                <select id="stateSelect" name="province" class="Gselect payFormInput validate[required]">
                    ...
                    <div class="payBlock payCredit">
                        ...
                        <div class="payInfoContainer">
                            <fieldset class="payForm payFormFull">
                                ...
                                <input id="ccName" data-stripe="name" type="text" class="payFormInput validate[required]"><input type="hidden" name="paymentcctype" id="ccType" value="" />
                            </fieldset>
