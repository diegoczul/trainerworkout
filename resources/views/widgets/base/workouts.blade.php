...
<div class="viewMore_holder view-more-btn-section pb-4 md:pb-0">
    @if (isset($countArchiveWorkouts) and $countArchiveWorkouts > 0)
        <a id="viewArchivedWorkouts" class="archive archive-btn" href="javascript:void(0)"
            onClick="viewArchivedWorkouts()"
            style="{{ $archive ? 'display: none' : '' }}">{{ Lang::get('content.viewArchivedWorkouts') }}</a>
        <a id="viewUnArchivedWorkouts" class="archive archive-btn" href="javascript:void(0)"
            onClick="viewUnArchivedWorkouts()"
