...
@if ($weights->count() > 0)
	...
	<div class="weighttable">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabulardata">
	                    <tr>
						<th >Date</th>
						<th class="pounds weights" style="display:block">Weight</th>
						<th class="kilograms weights" style="display:none">Weight</th>
						<th></th>
						</tr>
	...
	<canvas id="myChartKilo" width="650" height="300" style="display:none"></canvas>
		 ...
		 $.ajax(
	        {
	            ...
	            {
	                successMessage(data);
	                widgetsToReload.push("w_weights_full");
	                refreshWidgets();
	            },
...
@if($total > $weights->count())
	...
	<div class="btmbuttonholder">
                <div class="clearfix"></div>
                	...
                	<a href="javascript:void(0)" onclick="callWidget('w_weights_full',{{ $weights->count() }},null,$(this))" class="greybtn">More Weights</a>
                </div>
@endif
@else
