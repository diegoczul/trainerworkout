                ...
                <tr>
                    ...
                    <td
                        ...
                        <h4 class="friendMessage"
                            ...
                            {{ $authorFirstName }} {{ $authorLastName }} vous invite a joindre votre équipe sur YMCA!</h4>
                    </td>
                ...
                <tr>
                    <td
                        ...
                        <p
                            ...
                            YMCA vous aide à créer et partager vos programmes d'entraînement avec vos clients. Vous pourrai
                            aussi suivre le progrès de vos clients.</p>
                    </td>
                </tr>
                <tr>
                    <td
                ...
                <tr>
                    <td
                        ...
                        <p class="listItem"
                            ...
                            ou sur le bouton ci-haut afin de créer votre compte. Vous pouvez également copier & coller le
                            lien suivant dans votre navigateur préféré.</p>
                    </td>
                </tr>
                <tr>
                    <td
                ...
                @if ($password != '')
                    ...
                    <tr>
                        <td
                            ...
                            <p class="listItem"
                                style="margin: 1em 0;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: &quot;Avenir&quot;, &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;color: #4A4A4A;font-size: 20px;font-weight: 200;line-height: 115%;text-align: justify;">
                                Compte d'utilisateur: {{ $user->email }}</p>
                        </td>
                    </tr>
                    <tr>
                        <td
