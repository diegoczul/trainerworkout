                ...
                <tr>
                    <td colspan="3" align="left" valign="top" width="520"
                        ...
                        <h1 class="introMessage"
                            ...
                            Allo {{ isset($toUser) ? $toUser->firstName : ' ' }},</h1>
                    </td>
                </tr>
                <tr>
                    <td colspan="3"
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="520" id="contentBlock"
                            ...
                            <tr>
                                <td
                                    ...
                                    <p
                                        ...
                                        Votre client {{ $friendName }} vient de compléter {{ $workout->name }}.
                                        Félicitez-le en répondant à ce e-mail.</p>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td
                        ...
                        <p class="listItem"
                            ...
                            <strong>Entraînement:</strong> {{ $workout->name }}</p>
                    </td>
                </tr>
                <tr>
                    <td
                ...
                <tr>
                    <td
                        ...
                        <p class="listItem"
                            style="margin: 10px 0;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: &quot;Avenir&quot;, &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;color: #4A4A4A;font-size: 20px;font-weight: 200;line-height: 115%;text-align: justify;">
                            <strong>Commentaire:</strong> {{ $performance->comments }}</p>
                    </td>
                </tr>
                <tr>
                    <td
                        ...
                        <p class="listItem"
                            style="margin: 10px 0;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: &quot;Avenir&quot;, &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;color: #4A4A4A;font-size: 20px;font-weight: 200;line-height: 115%;text-align: justify;">
                            <strong>Sentiment:</strong> {{ $rating->name }}</p>
                    </td>
                </tr>
                <tr>
                    <td
                        ...
                        <p class="listItem"
                            style="margin: 10px 0;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: &quot;Avenir&quot;, &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;color: #4A4A4A;font-size: 20px;font-weight: 200;line-height: 115%;text-align: justify;">
                            <strong>Durée:</strong> {{ number_format($performance->timeInSeconds / 60, 1) }} min</p>
                    </td>
                </tr>
                <tr>
                    <td
                        ...
                        <p class="listItem"
                            style="margin: 10px 0;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: &quot;Avenir&quot;, &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;color: #4A4A4A;font-size: 20px;font-weight: 200;line-height: 115%;text-align: justify;">
                            <strong>Commencé le:</strong> {{ Helper::date($performance->created_at) }}</p>
                    </td>
                </tr>
                <tr>
                    <td
                        ...
                        <p class="listItem"
                            style="margin: 10px 0;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: &quot;Avenir&quot;, &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;color: #4A4A4A;font-size: 20px;font-weight: 200;line-height: 115%;text-align: justify;">
                            <strong>Complété le:</strong> {{ Helper::date($performance->completed) }}</p>
                    </td>
                </tr>
                <tr>
                    <td
                            ...
                            <tr>
                                <td align="center" valign="middle" class="actionButtonContent"
                                    ...
                                    <a href="{{ URL::secure(Lang::get('routes./Trainer/Reports/WorkoutsPerformanceClients')) }}"
                                        target="_blank"
                                        style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: &quot;Avenir&quot;, &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;background: #990124;display: inline-block;border-radius: 4px;color: #fff;padding: 10px 18px;text-decoration: none;font-size: 18px;border-bottom: solid 2px #560114;">Voir
                                        Rapport</a>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td
                        ...
                        <p class="listItem"
                            style="margin: 10px 0;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: &quot;Avenir&quot;, &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;color: #4A4A4A;font-size: 20px;font-weight: 200;line-height: 115%;text-align: justify;">
                            Vous pouvez également accéder au rapport de performance de vos clients en cliquant <a
                                class="hereLink"
                            ...
                            ou en copiant et collant le lien suivant dans votre navigateur préféré.</p>
                    </td>
                </tr>
                <tr>
                    <td
