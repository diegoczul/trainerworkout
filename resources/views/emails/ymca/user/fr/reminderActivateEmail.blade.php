                ...
                <tr>
                    ...
                    <td
                        ...
                        <h4 class="friendMessage"
                            ...
                            Merci d'avoir choisi YMCA {{ $user->firstName }}</h4>
                    </td>
                            ...
                            <tr>
                                <td align="center" valign="middle" class="actionButtonContent"
                                    ...
                                    <a href="{{ URL::secure('user/confirmation/' . $user->token) }}" user
                                        style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: &quot;Avenir&quot;, &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;background: #990124;display: inline-block;border-radius: 4px;color: #fff;padding: 10px 18px;text-decoration: none;font-size: 18px;border-bottom: solid 2px #560114;">onfirmer
                                        votre email</a>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td
                        ...
                        <p class="listItem"
                            ...
                            Cliquez <a class="hereLink" href="{{ URL::secure('user/confirmation/' . $user->token) }}" user
                            ...
                            pour confirmer votre email ou copiez collez le lien suivant dans votre navigateur préféré.</p>
                    </td>
                </tr>
                <tr>
                    <td
