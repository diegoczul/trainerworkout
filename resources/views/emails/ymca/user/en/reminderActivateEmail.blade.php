                ...
                <tr>
                    ...
                    <td
                        ...
                        <h4 class="friendMessage"
                            ...
                            Welcome to YMCA {{ $user->firstName }} {{ $user->lastName }}</h4>
                    </td>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="actionButton"
                            ...
                            <tr>
                                <td align="center" valign="middle" class="actionButtonContent"
                                    ...
                                    <a href="{{ URL::secure('user/confirmation/' . $user->token) }}" user
                                        style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: &quot;Avenir&quot;, &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;background: #990124;display: inline-block;border-radius: 4px;color: #fff;padding: 10px 18px;text-decoration: none;font-size: 18px;border-bottom: solid 2px #560114;">Confirm
                                        E-mail Address</a>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td
                        ...
                        <p class="listItem"
                            ...
                            Click <a class="hereLink" href="{{ URL::secure('user/confirmation/' . $user->token) }}" user
                            ...
                            to confirm your email or copy paste the following link in your favorite browser.</p>
                    </td>
                </tr>
                <tr>
                    <td
