...
@section('content')
    <?php if (isset($toUser)) {
        $toUser = unserialize($toUser);
    } ?>
    <?php if (isset($fromUser)) {
        $fromUser = unserialize($fromUser);
    } ?>
    <?php if (isset($fromUser)) {
    ...
    <?php if (isset($workout)) {
        $workout = unserialize($workout);
    } ?>
    <?php if (isset($performance)) {
        $performance = unserialize($performance);
    } ?>
    <?php if (isset($rating)) {
                ...
                <tr>
                    <td colspan="3" align="left" valign="top" width="520"
                        ...
                        <h1 class="introMessage"
                            ...
                            Hello {{ isset($toUser) ? $toUser->firstName : 'you' }},</h1>
                    </td>
                </tr>
                <tr>
                    <td colspan="3"
                        style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                        <h4 class="messageFromFriend"
                            style="margin: 0;padding: 0;font-family: &quot;Avenir&quot;, &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;color: #fff;font-size: 26px;font-weight: 100;line-height: 115%;text-align: center;padding-bottom: 10px;font-style: italic;">
                            comment from {{ $friendName }}:</h4>
                    </td>
                </tr>
                <tr>
                    <td class="quote1"
                        style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;width: 20px;vertical-align: top;padding-right: 5px;">
                        <img src="http://www.beta.trainer-workout.com/img/newsletter/quote1.png"
                            style="border: 0;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;"></td>
                    <td
                        style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                    ...
                    <td class="quote2"
                        style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;width: 20px;vertical-align: bottom;padding-left: 5px;">
                        <img src="http://www.beta.trainer-workout.com/img/newsletter/quote2.png"
                            style="border: 0;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;"></td>
                </tr>
            </table>
        </td>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="520" id="contentBlock"
                            ...
                            <tr>
                                <td
                                    ...
                                    <p
                                        ...
                                        Your client {{ $friendName }} has just finished performing the workout
                                        {{ $workout->name }}, congratulate your client by replying to this email!</p>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td
                        ...
                        <p class="listItem"
                            ...
                            <strong>Workout:</strong> {{ $workout->name }}</p>
                    </td>
                </tr>
                <tr>
                    <td
                        ...
                        <p class="listItem"
                            style="margin: 10px 0;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: &quot;Avenir&quot;, &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;color: #4A4A4A;font-size: 20px;font-weight: 200;line-height: 115%;text-align: justify;">
                            <strong>Client:</strong> {{ $friendName }}</p>
                    </td>
                </tr>
                <tr>
                    <td
                        ...
                        <p class="listItem"
                            style="margin: 10px 0;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: &quot;Avenir&quot;, &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;color: #4A4A4A;font-size: 20px;font-weight: 200;line-height: 115%;text-align: justify;">
                            <strong>Comments:</strong> {{ $performance->comments }}</p>
                    </td>
                </tr>
                <tr>
                    <td
                        ...
                        <p class="listItem"
                            style="margin: 10px 0;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: &quot;Avenir&quot;, &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;color: #4A4A4A;font-size: 20px;font-weight: 200;line-height: 115%;text-align: justify;">
                            <strong>Rating:</strong> {{ $rating->name }}</p>
                    </td>
                </tr>
                <tr>
                    <td
                        ...
                        <p class="listItem"
                            style="margin: 10px 0;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: &quot;Avenir&quot;, &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;color: #4A4A4A;font-size: 20px;font-weight: 200;line-height: 115%;text-align: justify;">
                            <strong>Duration:</strong> {{ number_format($performance->timeInSeconds / 60, 1) }} min</p>
                    </td>
                </tr>
                <tr>
                    <td
                        ...
                        <p class="listItem"
                            style="margin: 10px 0;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: &quot;Avenir&quot;, &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;color: #4A4A4A;font-size: 20px;font-weight: 200;line-height: 115%;text-align: justify;">
                            <strong>Started:</strong> {{ Helper::date($performance->created_at) }}</p>
                    </td>
                </tr>
                <tr>
                    <td
                        ...
                        <p class="listItem"
                            style="margin: 10px 0;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: &quot;Avenir&quot;, &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;color: #4A4A4A;font-size: 20px;font-weight: 200;line-height: 115%;text-align: justify;">
                            <strong>Completed:</strong> {{ Helper::date($performance->completed) }}</p>
                    </td>
                </tr>
                <tr>
                    <td
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="actionButton"
                            ...
                            <tr>
                                <td align="center" valign="middle" class="actionButtonContent"
                                    ...
                                    <a href="{{ URL::secure(Lang::get('routes./Trainer/Reports/WorkoutsPerformanceClients')) }}"
                                        target="_blank"
                                        style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: &quot;Avenir&quot;, &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;background: #990124;display: inline-block;border-radius: 4px;color: #fff;padding: 10px 18px;text-decoration: none;font-size: 18px;border-bottom: solid 2px #560114;">View
                                        Report</a>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td
                        ...
                        <p class="listItem"
                            style="margin: 10px 0;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: &quot;Avenir&quot;, &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;color: #4A4A4A;font-size: 20px;font-weight: 200;line-height: 115%;text-align: justify;">
                            You can also have access to your report and view how all of your clients are performing by
                            clickng <a class="hereLink"
                                href="{{ URL::secure(Lang::get('routes./Trainer/Reports/WorkoutsPerformanceClients')) }}"
                                style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: &quot;Avenir&quot;, &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;color: #4A4A4A;font-size: 20px;font-weight: 200;line-height: 115%;text-align: justify;">here</a>
                            or by copy pasting the following link in your favorite browser.</p>
                    </td>
                </tr>
                <tr>
                    <td
                        ...
                        <p class="link"
                            ...
                            {{ URL::secure(Lang::get('routes./Trainer/Reports/WorkoutsPerformanceClients')) }}</p>
                    </td>
                </tr>
            </table>
        </td>
