                ...
                <tr>
                    ...
                    <td
                        ...
                        <h4 class="friendMessage"
                            ...
                            You have been invited by {{ $authorFirstName }} {{ $authorLastName }} to join your team on YMCA!
                        </h4>
                    </td>
                ...
                <tr>
                    <td
                        ...
                        <p
                            ...
                            YMCA helps you create and share customized workouts with your clients. You will also be able to
                            track the progress of your clients.</p>
                    </td>
                </tr>
                <tr>
                    <td
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="actionButton"
                            ...
                            <tr>
                                <td align="center" valign="middle" class="actionButtonContent"
                                    ...
                                    <a href="{{ URL::secure('/user/confirmation/' . $user->token) }}"
                                        style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: &quot;Avenir&quot;, &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;background: #990124;display: inline-block;border-radius: 4px;color: #fff;padding: 10px 18px;text-decoration: none;font-size: 18px;border-bottom: solid 2px #560114;">Create
                                        Account</a>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td
                        ...
                        <p class="listItem"
                            ...
                            Click <a class="hereLink" href="{{ URL::secure('/user/confirmation/' . $user->token) }}"
                            ...
                            or the button above to create your account. You can also copy & paste the following link in your
                            favorite browser.</p>
                    </td>
                </tr>
                <tr>
                    <td
                        ...
                        <p class="link"
                            ...
                            {{ URL::secure('/user/confirmation/' . $user->token) }}</p>
                    </td>
                </tr>
                @if ($password != '')
                    <tr>
