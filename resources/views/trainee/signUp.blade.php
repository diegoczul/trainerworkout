...
<main class="accountPages">
    ...
    <div class="wrapper accountRoot">
        <div class="topBlock">
            <h1>{{ Lang::get("content.index11") }}</h1>
            <h3></h3>
        </div>
        <div class="accountAction_container">
            {{ Form::open(array('url' => Lang::get("routes./Trainee/SignUp"), "id"=>"login_form")); }}
                ...
                <input type="text" name="firstName" id="firstName" required placeholder="{{ Lang::get("content.First Name") }}" value="{{ Input::old("firstName") }}" />
                <label for="lastName">{{ Lang::get("content.Last Name") }}</label>
                <input type="text" name="lastName" id="lastName" required placeholder="{{ Lang::get("content.Last Name") }}" value="{{ Input::old("lastName") }}" />
                <label for="email">{{ Lang::get("content.Email") }}</label>
                <input type="text" name="email" id="email" required placeholder="{{ Lang::get("content.Email") }}" value="{{ Input::old("email") }}" />
