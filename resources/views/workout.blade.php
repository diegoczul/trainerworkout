                            ...
                            @else
                                @foreach($exercises as $exercise)
                                    @if($exercise->exercises->bodygroupId != 18)
                                        ...
                                        <!------------------------ MUSCLE EXERCISE ------------------------>
                                        <div class="exercise muscle" exercise="" data-exercise-id="{{ $exercise->exercises->id }}">
                                            <div class="exercise_Header">
...
<script>
    ...
    function openAITrainerChat(element) {
        // Find the exercise container (works for both circuit and single exercises)
        const exerciseContainer = element.closest('.cExercise') || element.closest('.exercise');
        
        if (!exerciseContainer) {
            alert('Exercise container not found');
            return;
        }
        ...
        // Get exercise name from header (different selectors for circuit vs single exercises)
        let exerciseNameElement = exerciseContainer.querySelector('.cExercise_header_info h5');
        if (!exerciseNameElement) {
            exerciseNameElement = exerciseContainer.querySelector('.exercise_Header h5');
        }
