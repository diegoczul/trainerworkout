<!-- This page is where people go to reset their password after they clicked on the link to reset password from their home -->
    ...
    <div class="wrapper accountRoot">
        ...
        <div class="accountAction_container">
            {{ Form::open(array('route' => array('password.update', $token),"class"=>"formholder form-line-height", "id"=>"password_reset")) }}
                ...
                <input type="text" placeholder="{{ Lang::get("content.reset/youremail") }}" value="{{ $email or Input::old('email') }}" required name="email" id="email" />

                <label for="password">{{ Lang::get("content.reset/yourpassword") }}</label>
                <input placeholder="{{ Lang::get("content.reset/password") }}" required name="password" type="password" id="password" value="{{Input::old("password")}}"/>

                <label for="password_confirmation">{{ Lang::get("content.reset/yourpassword") }}</label>
                <input type="password" id="password_confirmation" name="password_confirmation" placeholder="{{ Lang::get("content.reset/placeholder") }}" value="{{Input::old("password_confirmation")}}" />
