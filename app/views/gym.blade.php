...
<main class="gym">
    ...
    <section id="jumbotron">
        ...
        <div class="content">
            <div class="wrapper">
                <h1>{{{ Lang::get("content.gym/jumbotron1") }}}<!-- <br>{{{ Lang::get("content.gym/jumbotron2") }}}--> <br> 
                ...
                <a href="{{ Lang::get("routes./TrainerSignUp") }}" class="action">{{ Lang::get("content.gym/cta") }}</a>
            </div>        
        </div> 
    </section>
                    ...
                    <div class="deviceContainer">
                        <div class="device iPhone7-portrait">
                            ...
                            <div id="gbranding" class="screen">
                                <img class="header" src="/img/website/Gym_GymClientFeat1_Header_Iphone6_940.gif">
                                <div class="scrollableContainer">
                                    <img class="scrollable coreAsset" src="/img/website/Gym_GymClientFeat1_iphone6_2.gif">
                                </div>
                            </div>
                            <div id="acitivtyLog" class="screen hideMe">
                                <!-- <img class="header" src="/img/website/iPhone7-portrait-header.png"> -->
                                <div class="scrollableContainer">
                                    <img class="scrollable coreAsset" src="/img/website/GymClientFeat2_ipadHorizontal.gif">
                                </div>
                            </div>
                           <!--  <div id="progress" class="screen hideMe">
                            ...
                            <div id="workouts" class="screen hideMe">
                                <!-- <img class="header" src="/img/website/iPhone7-portrait-header.png"> -->
                                <div class="scrollableContainer">
                                    <img class="scrollable coreAsset" src="/img/website/GymClientFeat3_IpadVertical.png">
                                </div>
                            </div>
                        </div>
                        <div class="message">
                    ...
                    <div class="deviceContainer">
                        <div class="device iPad-landscape">
                            ...
                            <div id="employee" class="screen">
                                <div class="scrollableContainer">
                                    <img class="scrollable coreAsset" src="/img/website/GymControlFeat1_IpadHorizontal.gif">
                                </div>
                            </div>
                            <div id="global" class="screen hideMe">
                                <div class="scrollableContainer">
                                    <img class="scrollable coreAsset" src="/img/website/GymControlFeat2_Iphone6.png">
                                </div>
                            </div>
                            <div id="collaboration" class="screen hideMe">
                                <div class="scrollableContainer">
                                    <img class="scrollable coreAsset" src="/img/website/GymControlFeat3_IpadVertical.gif">
                                </div>
                            </div>
                        </div>
                        <div class="message">
