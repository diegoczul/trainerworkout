    ...
    <div class="wrapper">
        <div class="content">
            <div class="device iPad-portrait">
                ...
                <div class="screen">
                    <img alt='{{ Lang::get("content.Trainer Workout Header IPAD APP") }}' class="header" src="/img/website/iPad-portrait-header.png">
                    <div class="scrollableContainer">
                        <img alt='{{ Lang::get("content.Trainer Workout - Ipad App") }}' class="scrollable coreAsset" src="/img/website/iPad-portrait-primary.png">
                    </div>
                ...
                <div class="deviceContainer">
                    <div class="device iPhone7-portrait">
                        ...
                        <div id="branding" class="screen">
                            <img alt='{{ Lang::get("content.Trainer workout - Iphone App") }}' class="header" src="/img/website/iPhone7-portrait-header.png">
                            <div class="scrollableContainer">
                                <img  alt='{{ Lang::get("content.Trainer workout - Personal Training Branding and White Label") }}' class="scrollable coreAsset" src="/img/website/secondary-branding.png">
                            </div>
                        </div>
                        <div id="clientFiles" class="screen hideMe">
                            <img alt='{{ Lang::get("content.Trainer Workout - Ipad Landscape") }}' class="header" src="/img/website/iPad-landscape-header.png">
                            <div class="scrollableContainer">
                                <img alt='{{ Lang::get("content.Trainer Workout - Ipad Icon") }}' class="scrollable coreAsset" src="/img/website/iPad-portrait-primary.png">
                            </div>
                        </div>
                        <div id="notifications" class="screen hideMe">
                            <img alt='EmailHeader Trainer Workout' class="header" src="/img/website/emailHeader.png">
                            <div class="scrollableContainer">
                                <img alt='{{ Lang::get("content.Workout Notification") }}' class="scrollable coreAsset" src="/img/website/secondary-notification.png">
                            </div>
                        </div>
                        <div id="tracking" class="screen hideMe">
                            <img alt='{{ Lang::get("content.Personal Training Software") }}' class="header" src="/img/website/desktop-header.png">
                            <div class="scrollableContainer">
                                <img alt='{{ Lang::get("content.Personal Training Software2") }}' class="scrollable coreAsset" src="/img/website/secondary-report.png">
                            </div>
                        </div>
                    </div>
                    <div class="message">
                ...
                <div class="deviceContainer">
                    <div class="device none">
                        ...
                        <div id="exercises" class="screen">
                            <div class="scrollableContainer">
                                <img alt='{{ Lang::get("content.Personal Training Exercises") }}' class="scrollable coreAsset" src="/img/website/third-exercises.png">
                            </div>
                        </div>
                        <div id="builder" class="screen hideMe">
                            <div class="scrollableContainer">
                                <img alt='{{ Lang::get("content.Workout Builder") }}' class="scrollable coreAsset" src="/img/website/third-builder.gif">
                            </div>
                        </div>
                        <div id="share" class="screen hideMe">
                            <div class="scrollableContainer">
                                <img alt='{{ Lang::get("content.Share Workouts Online") }}' class="scrollable coreAsset" src="/img/website/third-share.gif">
                            </div>
                        </div>
                        <div id="print" class="screen hideMe">
                            <div class="scrollableContainer">
                                <img alt='{{ Lang::get("content.Print Workouts Online") }}' class="scrollable coreAsset" src="/img/website/third-print.png">
                            </div>
                        </div>
                    </div>
                    <div class="message">
