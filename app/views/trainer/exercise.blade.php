...
@section("content")
 ...
 <div class="wrapper">
<div class="widgets fullwidthwidget shadow marginleftnone"> <button class="bluebtn"  onClick="window.history.back()" value="">{{ Lang::get("content.Back") }}</button> </div>
            <div class="widgets fullwidthwidget shadow marginleftnone">
                ...
                <div class="add-exercises clearfix">
                  ...
                  <div class="fltleft exercisesblockleft marginleftnone">
                    ...
                    <p> <strong> {{ ($exercise->nameEngine) ? "".Lang::get("content.Othernamesforthisexercise").": </strong> </p>
                    <p> ".$exercise->nameEngine : "" }} </p>
                  ...
                  <div class="fltright exercisesblockright">
                    ...
                    <div id="image1" class="showDelete showRotate">
                      ...
                      @if($exercise->editPermissions())
                       <a href="javascript:void(0)" onClick="rotateLeft({{ $exercise->id }},$(this),1); arguments[0].stopPropagation(); return false;" class="showRotateReceiver inlineIcon"><img src="/img/rotate_left.png"/></a>
                        <a href="javascript:void(0)" onClick="rotateRight({{ $exercise->id }},$(this),1); arguments[0].stopPropagation(); return false;" class="showRotateReceiver2 inlineIcon"><img src="/img/rotate_right.png"/></a>
                      @endif
                    </div>
                    <div id="image2" class="showDelete showRotate" style="margin-left: 20px">
                      ...
                      @if($exercise->editPermissions())
                       <a href="javascript:void(0)" onClick="rotateLeft({{ $exercise->id }},$(this),2); arguments[0].stopPropagation(); return false;" class="showRotateReceiver inlineIcon"><img src="/img/rotate_left.png"/></a>
                        <a href="javascript:void(0)" onClick="rotateRight({{ $exercise->id }},$(this),2); arguments[0].stopPropagation(); return false;" class="showRotateReceiver2 inlineIcon"><img src="/img/rotate_right.png"/></a>
                        @endif
                      </div>
