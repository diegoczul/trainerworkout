      ...
      {{ Form::open(array('url' => Lang::get("routes./Exercises/AddExercise"), 'enctype' => 'multipart/form-data', "files"=>true, 'name' => 'exercise')); }}
          ...
          <div class="addexercise-stepContainer"> 
            <div class="addexercise-step active">
              ...
              <input type="text" name="name" placeholder="bench press, bicep curl, etc..." value="{{ Input::old('name') }}" tabindex="1">
              ...
              <fieldset class="exerciseDescription">
                ...
                <textarea id="description" class="addexdescription" name="description" maxlength="500" placeholder="{{ Lang::get("content.Exercisedescription") }}">{{ Input::old("description") }}</textarea>
                <div id="textarea_counter"></div>
              </fieldset>

              <div class="muscleGroup">
                <label for="" tabindex="3">{{ Lang::get("content.Musclegroups") }}*</label>                       
                {{ FORM::select( "bodygroup", array(""=>Lang::get("content.MuscleGroupChoose"))+$bodygroups, Input::old("bodygroup")) }}
              </div>

              <div class="submit">
                <label class="next" onclick="addExerciseSwtichStep()">Next step <img src="/img/svg/arrowNext.svg"></label>
              </div>
