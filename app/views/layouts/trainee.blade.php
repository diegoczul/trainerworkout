    ...
    <div class="navContentContainer">
        <nav>
            ...
            <div class="navItem" id="headerLogo">
                <img src="{{ Config::get("app.logo_over_white") }}" />
            </div>
...
<nav id="c-menu--push-left" class="c-menu c-menu--push-left">
    ...
    <ul class="c-menu__items">
        <div class="menu-section">
            <li class="c-menu__item"><a href="{{ Lang::get("routes./Trainee/Profile") }}" class="c-menu__link">{{ Lang::get("content.CMProfile") }}</a></li>
        </div>
        <div class="menu-section">
            <li class="c-menu__item"><a href="{{ Lang::get("routes./Trainee/Workouts") }}" class="c-menu__link">{{ Lang::get("content.CMWorkouts") }}</a></li>
        </div>
        <div class="menu-section">
            <li class="c-menu__item"><a href="javascript:void(Tawk_API.toggle())" class="c-menu__link">{{ Lang::get("content.Support") }}</a></li>
