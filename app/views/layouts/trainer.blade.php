...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/fw/addtohomescreen/style/addtohomescreen.css">
    ...
    <div class="navContentContainer">
        <nav>
            ...
            <div class="navItem" id="headerLogo">
                <img src="{{ Config::get("app.logo_header") }}" />
            </div>
            ...
            <div class="navItem navOptions">
              @if((Auth::user()->membership && Auth::user()->membership->membershipId == Config::get("constants.defaultMembership")) or (!Auth::user()->membership))
                <form action="{{ Lang::get("routes./UpgradePlan") }}"><button type="submit" value="Upgrade">{{ Lang::get("content.upgrade") }}<!-- <a href="{{ Lang::get("routes./UpgradePlan") }}">{{ Lang::get("content.upgrade") }}</a> --></button></form>
              @endif
              <div class="navLang">
...
<nav id="c-menu--push-left" class="c-menu c-menu--push-left">
    ...
    <ul class="c-menu__items">
        ...
        <div class="menu-section">
          <li class="c-menu__item"><a href="{{ Lang::get("routes./Trainer/Workouts")."/".Helper::formatURLString(Auth::user()->firstName.Auth::user()->lastName) }}" class="c-menu__link menu_workouts">{{ Lang::get("content.TWorkouts") }}</a></li>
          <li class="c-menu__item"><a href="{{ Lang::get("routes./Trainer/Exercises") }}" class="c-menu__link menu_exercises">{{ Lang::get("content.TExercises") }}</a></li>
        </div>

        <div class="menu-section">
          <li class="c-menu__item"><a href="{{ Lang::get("routes./Trainer/Clients") }}" class="c-menu__link menu_clients">{{ Lang::get("content.TClients") }}</a></li>
          <li class="c-menu__item"><a href="{{ Lang::get('routes./Trainer/Reports/WorkoutsPerformanceClients') }}" class="c-menu__link menu_clientsReports">{{ Lang::get("content.TClientReport") }}</a></li>
        </div>


        @if(Auth::user()->group and (Auth::user()->group->role == "Owner" or Auth::user()->group->role == "Admin"))
        <div class="menu-section">
          <li class="c-menu__item"><a href="{{ Lang::get("routes./employeeManagement") }}" class="c-menu__link menu_employee">{{ Lang::get("content.EmployeeManagement") }}</a></li>
        @endif
        </div>
        <div class="menu-section">
          <li class="c-menu__item"><a href="{{ Lang::get("routes./Trainer/Profile") }}" class="c-menu__link menu_profile">{{ Lang::get("content.TProfile") }}</a></li>
          @if(!(Auth::user()->group and Auth::user()->group->role == "Member"))
          <li class="c-menu__item"><a href="{{ Lang::get("routes./MembershipManagement") }}" class="c-menu__link menu_membership">{{ Lang::get("content.TMembership") }}</a></li>
          @endif
        </div>
        <div class="menu-section">
          <li class="c-menu__item"><a href="javascript:void(0)" onclick="moveFeedbackUp();" class="c-menu__link">{{ Lang::get("content.CMSendFeedback") }}</a></li>
          <li class="c-menu__item logout"><a href="{{ Lang::get("routes./logout") }}" class="c-menu__link">{{ Lang::get("content.Logout") }}</a></li>
        </div>
    </ul>
...
<div class="fb_overlay">
    <svg class="c-menu__close" width="15" height="15" viewBox="0 0 15 15" xmlns="https://www.w3.org/2000/svg" onclick="moveFeedbackDown();">
        <title>
            Close Icon
        </title>
        <path class="closeIcon" d="M7.5 4.865L3.536.9a1.874 1.874 0 0 0-2.65 2.65L4.85 7.516.916 11.45a1.874 1.874 0 1 0 2.65 2.65L7.5 10.166l3.934 3.934a1.874 1.874 0 1 0 2.65-2.65L10.15 7.514l3.965-3.964A1.874 1.874 0 0 0 11.465.9L7.5 4.865z" fill-opacity=".52" fill="#FFF" fill-rule="evenodd"/></path>
...
<!-- End of Side Mneu -->
    ...
    {{ HTML::script('fw/addtohomescreen/src/addtohomescreen.js'); }}


    {{ HTML::script('app/views/templates/exerciseList.js'); }}
    {{ HTML::script('app/views/templates/workoutBuilder.js'); }}
...
<!--End of Tawk.to Script-->
        ...
        @endif
          ...
          <script>(function(){var w=window;var ic=w.Intercom;if(typeof ic==="function"){ic('reattach_activator');ic('update',intercomSettings);}else{var d=document;var i=function(){i.c(arguments)};i.q=[];i.c=function(args){i.q.push(args)};w.Intercom=i;function l(){var s=d.createElement('script');s.type='text/javascript';s.async=true;s.src='https://widget.intercom.io/widget/af0obxyk';var x=d.getElementsByTagName('script')[0];x.parentNode.insertBefore(s,x);}if(w.attachEvent){w.attachEvent('onload',l);}else{w.addEventListener('load',l,false);}}})()</script>
