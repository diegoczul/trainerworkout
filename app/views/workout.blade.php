...
<section id="workoutView" class="clearfix">
    ...
    <div class="wrapper">
        <div class="moreOptions_view">
            ...
            <!-- PRINT -->
            <a title="Print" target="_blank" href="{{ Lang::get("routes./Workout/PrintWorkout/") }}{{ $workout->id }}/" id="printWorkouts" class="moreOptionsButton moreOptionsWorkoutButton">
                <svg width="20" height="20" viewBox="0 0 20 20" xmlns="https://www.w3.org/2000/svg">
                    <title>
                        print
                    </title>
                    <g stroke="#369AD8" fill="none" fill-rule="evenodd">
                        <rect x="3.2" width="14" height="10" rx="1.2"/></rect>
                        <rect fill="#F2F2F2" y="4.8" width="20" height="10" rx="1.2"/></rect>
                        <circle stroke-width=".5" fill="#FFF" cx="14.2" cy="7.8" r=".8"/></circle>
                        <circle stroke-width=".5" fill="#FFF" cx="17" cy="7.8" r=".8"/></circle>
                ...
                <div class="printMenu loadingParent" id="downloadMenu">
                    <ul>
                        <li id="printJpeg"><a href="javascript:void(0)" onclick="downloadJPEG(this)"><img src="/img/printWorkout/jpegIcon.svg"><p>JPEG {{ Lang::get("content.file") }}</p></a></li>
                        <li id="printPdf"><a href="javascript:void(0)" onclick="downloadPDF(this)"><img src="/img/printWorkout/pdfIcon.svg"><p>PDF {{ Lang::get("content.file") }}</p></a></li>
                        <li id="printJpegPdf"><a href="javascript:void(0)" onclick="downloadBoth(this)"><img src="/img/printWorkout/pdfIcon.svg"><p>PDF</p> <span> + </span><img src="/img/printWorkout/jpegIcon.svg"> <p>JPEG {{ Lang::get("content.file") }}</p></a></li>
                    </ul>
                </div>
            ...
            <a title="Share" href="javascript:void(0)" class="moreOptionsButton moreOptionsWorkoutButton" id="shareWorkouts"  onClick="lightBox();">
                <svg width="11" height="20" viewBox="0 0 11 20" xmlns="https://www.w3.org/2000/svg">
                  ...
                  <path d="M7.136 7.43C9.386 7.43 10 8 10 8.71v9.007C10 18.427 9.45 19 8.772 19H2.228C1.55 19 1 18.426 1 17.717V8.71c0-.707.818-1.28 2.66-1.28m-2.25-3L5.5 1l4.295 3.43M5.5 1.7v11.9" stroke="#369AD8" stroke-width=".9" fill="none" fill-rule="evenodd"/></path>
                </svg>
            ...
            <a title="Edit" href="{{ $workout->getEditURL() }}" class="moreOptionsButton moreOptionsWorkoutButton" onclick="lightBoxLoadingTwSpinner()">
                <svg width="17" height="24" viewBox="0 0 17 24" xmlns="https://www.w3.org/2000/svg">
                    ...
                    <g stroke="#369AD8" fill="none" fill-rule="evenodd">
                        <path d="M9.714 1.38A1.7 1.7 0 0 1 12.01.675l3.187 1.695a1.7 1.7 0 0 1 .697 2.298l-8.166 15.36c-.442.83-1.478 1.864-2.296 2.3L2.894 23.68c-.827.44-1.577.034-1.673-.89l-.297-2.86c-.097-.93.184-2.362.624-3.19L9.714 1.38z" stroke-width="1.3"/></path>
                        <path d="M2.11 18.477l3.863 2.054" stroke-width=".85" stroke-linecap="square"/></path>
                    </g>
                </svg>
            <!-- {{ Lang::get("content.edit") }} -->
               ...
               <!-- Delete  -->
            <a title="Delete" href="{{ Lang::get("routes./Workouts/removeWorkout/") }}{{ $workout->id }}/" class="moreOptionsButton moreOptionsWorkoutButton" onclick="lightBoxLoadingTwSpinner()">
            ...
            <a title="Download" class="moreOptionsButton moreOptionsWorkoutButton" href="javascript:void(0)" onclick="downloadBoth(this)">
                <svg width="15" height="17" viewBox="0 0 15 17" xmlns="https://www.w3.org/2000/svg">
                    ...
                    <g stroke="#369AD8" fill="none" fill-rule="evenodd">
                        <path d="M.5 12.5v2c0 1.105.897 2 2.006 2h9.988a1.998 1.998 0 0 0 2.006-2v-2" stroke-linecap="square"/></path>
                        <path d="M3 9.43l4.09 3.427 4.296-3.428M7.09 12.157V.258" stroke-width=".9"/></path>
                    </g>
                </svg>
                ...
                <div class="top">
                    ...
                    <div class="viewWorkoutHeader_powered">
                        @if(Config::get("app.whitelabel") != "default")
                            ...
                            @endif 
                        <img class="companyLogo" src="{{ Config::get("app.logo_on_image") }}">
                    </div>
                </div>
                <div class="viewWorkoutHeader_info">
                    <h2 id="title_VW">{{ $workout->name }}</h2>
                    <!-- CREATED BY -->
                    <h3 id="subtitle_VW">{{ $workout->author->firstName }} {{ $workout->author->lastName }}</h3>
                    <hr>
    ...
    <!------------------------ CIRCUIT ------------------------>
            ...
            <!-- EXERCISE IMAGE -->
                        ...
                        <div class="tabSwitcherParent exerciseVisualContainer">
                            ...
                            @if($exercise->exercises->video != "") 
                                <div class="tabs exerciseVideoTab videoTab {{ ($active == "video" ? "showTab" : "") }}">
                                    <div class="exercise_video_container" style="background-color: #000; width: {{ ($agent->isDesktop() ? Config::get("constants.constantsDesktopSizeVideo_w") : ($agent->isTablet() ?  Config::get("constants.constantsTabletSizeVideo_w") :  Config::get("constants.constantsMobileSizeVideo_w")))  }}; height: {{ ($agent->isDesktop() ? Config::get("constants.constantsDesktopSizeVideo_h") : ($agent->isTablet() ?  Config::get("constants.constantsTabletSizeVideo_h") :  Config::get("constants.constantsMobileSizeVideo_h")))  }}; color: #FFF;">
                                          ...
                                          <video id="my-video" class="video-js" controls preload="auto" style="width:100%; max-height:{{ ($agent->isDesktop() ? Config::get("constants.constantsDesktopSizeVideo_h") : ($agent->isTablet() ?  Config::get("constants.constantsTabletSizeVideo_h") :  Config::get("constants.constantsMobileSizeVideo_h")))  }}"

                                          poster="/{{ Helper::image(null,"video") }}" data-setup="{}">
                                ...
                                @endif
                                 @if($exercise->exercises->youtube != "") 
                                <div class="tabs exerciseYoutubeTab youtubeTab {{ ($active == "youtube" ? "showTab" : "") }}">
                                    <div class="exercise_video_container" style="background-color: #000; width: {{ ($agent->isDesktop() ? Config::get("constants.constantsDesktopSizeVideo_w") : ($agent->isTablet() ?  Config::get("constants.constantsTabletSizeVideo_w") :  Config::get("constants.constantsMobileSizeVideo_w")))  }}; height: {{ ($agent->isDesktop() ? Config::get("constants.constantsDesktopSizeVideo_h") : ($agent->isTablet() ?  Config::get("constants.constantsTabletSizeVideo_h") :  Config::get("constants.constantsMobileSizeVideo_h")))  }}; color: #FFF;">
                                        @if($exercise->exercises->youtube != "") 
                      ...
                      src="https://www.youtube.com/embed/{{$exercise->exercises->youtube }}"">?autoplay=1" frameborder="0"> </iframe>
                                        @endif
                                    </div>
                                </div>
                                @endif
                        ...
                        <div class="exeData">
                            ...
                            <table>
                                ...
                                @foreach($sets as $set)
                                    ...
                                    @if($set->rest != "")
                                        <tr><td class="restBtwSet" colspan="4">{{ $set->rest }} {{ Lang::get("content.secrestbeforenextsets") }}</td></tr>
                                    @endif
                                @endforeach
                                </tbody>    
                            </table>
            ...
            <!-- Rest Between Exercise in Circuit -->
                    <div class="circuitRestBtwExe">
                        <svg width="27" height="27" viewBox="0 0 27 27" xmlns="https://www.w3.org/2000/svg">
                            ...
                            <g transform="translate(1 1)" fill="none" fill-rule="evenodd">
                                <circle stroke="#2C3E50" fill="#FFF" cx="12.5" cy="12.5" r="12.5"/></circle>
                                <path fill="#2C3E50" d="M7 6h4v13H7zM14 6h4v13h-4z"/></path>
                            </g>
                        </svg>
                            ...
                            <table class="">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="tbSpeed" scope="col">{{ Lang::get("content.Speed") }} <span class="exercise_units_speed_unit_{{ $exercise->id }}"> {{ ($exercise->units == "Metric") ? Lang::get("content.km") : Lang::get("content.mi") }}</span></th>
                                        <th class="tbDist" scope="col">{{ Lang::get("content.Distance") }}</th>
        ...
        @endforeach
                ...
                <div class="endCircuit">
                    <svg width="27" height="27" viewBox="0 0 27 27" xmlns="https://www.w3.org/2000/svg">
                        ...
                        <g transform="translate(1 1)" fill="none" fill-rule="evenodd">
                            <circle stroke="#2C3E50" stroke-width=".926" fill="#FFF" cx="12.5" cy="12.5" r="12.5"/></circle>
                            <path d="M19.136 12.963c0-.815-.158-1.595-.445-2.313-.975-2.438-3.448-4.17-6.344-4.17A6.95 6.95 0 0 0 7.84 8.115m-2.284 4.85c0 3.58 3.04 6.48 6.79 6.48 1.332 0 3.623-1 3.623-1" stroke="#2C3E50" stroke-width="1.852"/></path>
                            <path fill="#2C3E50" d="M20.103 16.754l.96-5.646-5.055 1.642zM6.354 8.118L3.18 12.886l5.287.555z"/></path>
                        </g>
                    </svg>
                    @if($group->circuitType == "emom")
        ...
        @if($exercise->exercises->bodygroupId != 18)
            ...
            <div class="exercise muscle" exercise="">
                <div class="exercise_Header">
                    ...
                    <h5>{{ $exercise->exercises->name }} @if($exercise->equipmentId != "" and $exercise->equipment) {{ Lang::get("content.with") }} {{{ $exercise->equipment->name  }}}@endif</h5>
                </div>
                        ...
                        <div class="exercise_image_container">
                            ...
                            <div class="tabs exerciseVideoTab videoTab {{ ($active == "video" ? "showTab" : "") }}">
                                    <div class="exercise_video_container" style="background-color: #000; max-width:450px; width: {{ ($agent->isDesktop() ? Config::get("constants.constantsDesktopSizeVideo_w") : ($agent->isTablet() ?  Config::get("constants.constantsTabletSizeVideo_w") :  Config::get("constants.constantsMobileSizeVideo_w")))  }}; height: {{ ($agent->isDesktop() ? Config::get("constants.constantsDesktopSizeVideo_h") : ($agent->isTablet() ?  Config::get("constants.constantsTabletSizeVideo_h") :  Config::get("constants.constantsMobileSizeVideo_h")))  }}; color: #FFF;">
                                          ...
                                          poster="/{{ Helper::image(null,"video") }}" data-setup="{'fluid': true}">
                                            <source src="/{{ $exercise->exercises->video}}" type='video/mp4'>
                                            <source src="MY_VIDEO.webm" type='video/webm'>
                                            <p class="vjs-no-js">
                                              To view this video please enable JavaScript, and consider upgrading to a web browser that
            ...
            <!-- ---- EXERCISE DATA ---- -->
                ...
                <!-- EXERCISE TEMPO -->
                        ...
                        <table class="exeData_table">
                            ...
                            <thead>
                                <tr>
                                    <th class="tbSet" scope="col">{{ Lang::get("content.Set") }}</th>
                                    <th class="tbWeight" scope="col">{{ Lang::get("content.Weight") }}</th>
                                    <th class="tbRep" scope="col">
                                        @if($exercise->metricVisual == "rep")
                                            {{ Lang::get("content.Repetitions")  }}
    ...
    <!------------------------ CARDIO EXERCISE ------------------------>
            ...
            <div class="exercise cardio" exercise"">
                ...
                <div class="tabSwitcherParent exerciseVisualContainer">
                    ...
                    <div class="exercise_image_container">
                        <div class="tabs exerciseImageTab imagesTab  {{ ($active == "images" ? "showTab" : "") }}">
                            <a href="/{{ Helper::image($exercise->exercises->image) }}" data-lightbox="ex_{{ $exercise->id }}" ><img  src="/{{ Helper::image($exercise->exercises->image) }}" alt="{{ $exercise->exercises->name }}"></a>
                        @if($exercise->exercises->image2 != "")
                            <a href="/{{ Helper::image($exercise->exercises->image2) }}" data-lightbox="ex_{{ $exercise->id }}" ><img  src="/{{ Helper::image($exercise->exercises->image2) }}" alt="{{ $exercise->exercises->name }}"></a>
                        @endif
                        ...
                        @if($exercise->exercises->video != "") 
                        <div class="tabs exerciseVideoTab videoTab {{ ($active == "images" ? "video" : "") }}">
                                    <div class="exercise_video_container" style="background-color: #000; width: {{ ($agent->isDesktop() ? Config::get("constants.constantsDesktopSizeVideo_w") : ($agent->isTablet() ?  Config::get("constants.constantsTabletSizeVideo_w") :  Config::get("constants.constantsMobileSizeVideo_w")))  }}; height: {{ ($agent->isDesktop() ? Config::get("constants.constantsDesktopSizeVideo_h") : ($agent->isTablet() ?  Config::get("constants.constantsTabletSizeVideo_h") :  Config::get("constants.constantsMobileSizeVideo_h")))  }}; color: #FFF;">
                                ...
                                <div class="tabs exerciseYoutubeTab youtubeTab {{ ($active == "youtube" ? "showTab" : "") }}">
                                    <div class="exercise_video_container" style="background-color: #000; width: {{ ($agent->isDesktop() ? Config::get("constants.constantsDesktopSizeVideo_w") : ($agent->isTablet() ?  Config::get("constants.constantsTabletSizeVideo_w") :  Config::get("constants.constantsMobileSizeVideo_w")))  }}; height: {{ ($agent->isDesktop() ? Config::get("constants.constantsDesktopSizeVideo_h") : ($agent->isTablet() ?  Config::get("constants.constantsTabletSizeVideo_h") :  Config::get("constants.constantsMobileSizeVideo_h")))  }}; color: #FFF;">
                                        @if($exercise->youtube != "") 
                                       <iframe id="ytplayer" type="text/html" width="{{ ($agent->isDesktop() ? Config::get("constants.constantsDesktopSizeVideo_w") : ($agent->isTablet() ?  Config::get("constants.constantsTabletSizeVideo_w") :  Config::get("constants.constantsMobileSizeVideo_w")))  }}" height="{{ ($agent->isDesktop() ? Config::get("constants.constantsDesktopSizeVideo_h") : ($agent->isTablet() ?  Config::get("constants.constantsTabletSizeVideo_h") :  Config::get("constants.constantsMobileSizeVideo_h")))  }}"
                      src="https://www.youtube.com/embed/{{$exercise->youtube }}"">?autoplay=1" frameborder="0"> </iframe>
                                        @endif
                                    </div>
                                </div>
                                @endif
                        ...
                        <table class="">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="tbSpeed" scope="col">{{ Lang::get("content.Speed") }}</th>
                                    <th class="tbDist" scope="col">{{ Lang::get("content.Distance") }}</th>
                                    <th class="tbTime" scope="col">{{ Lang::get("content.Time") }}</th>
                                    <th class="tbMode">{{ Lang::get("content.Mode") }}</th>
                                </tr>
                            ...
                            @foreach($sets as $set)
                                ...
                                <tr>
                                    <th scope="row">{{ Helper::setNumber($set->number,$set->workoutsExercises->sets)  }}</th>
                                    <td>{{ ($set->bpm == "" || $set->bpm == "0" ? "-" : "$set->bpm")}}<span>
                                        @if($set->metric == "Vo2Max" || $set->metric == "effort")
                                             %
                                        @elseif($set->metric == "reserve")
                                             bpm
    ...
    <div id="step1">
        <div id="timer">
            <div class="timerButton">
                ...
                <label id="label" for=btn>{{ Lang::get("content.Start timer") }}</label>
            </div>             
            <div id=n1 ></div>
            <a href="javascript:void(0)" onclick="discartOld()">{{ Lang::get("content.Discard old and start new") }}</a>
        </div>
    ...
    <div class="overlayPerform showPerformancePopUp">
        <form action="{{ Lang::get("routes./Workout/Performance") }}" method="post" />
            ...
            <div class="performOptions">
                <svg width="15" height="15" viewBox="0 0 15 15" xmlns="https://www.w3.org/2000/svg" onclick="closePerformance();">
                    <title>
                        Close Icon
                    </title>
                ...
                <ul id="step2">
                    ...
                    <li onclick="nextStep(3)"><label for="rating{{ $rating->id }}"><p>{{ $rating->name }}</p></label><input id="rating{{ $rating->id }}" type="radio" name="rating" value="{{ $rating->id }}" /></li>
                    @endforeach
                </ul>
                <div id="step3" class="">
                    ...
                    <div class="submit"><button onClick="lightBoxLoadingTwSpinner();" type="submit">{{ Lang::get("content.Submit") }}</button></div>
                </div>
            </div>
...
console.log("click");
    switch(action)
    {
        case  'Stop':
            ...
            document.getElementById('label').innerHTML = dict['Start timer'];
            break;
        case  'Start':
            ...
            document.getElementById('label').innerHTML = dict['Stop timer'];
            break;
    }
}
...
@foreach($exercises as $exercise)
    @if($exercise->exercises->video != "")
        flowplayer('player{{ $exercise->id }}', '/fw/flowplayer/flowplayer-3.2.2.swf', {wmode: "transparent", clip: {
            autoPlay: false,
            autoBuffering: true }   
        });
    @endif
