...
$(function() {
    $('a.page-scroll').bind('click', function(event) {
        ...
        $('html, body').stop().animate({
            scrollTop: $($anchor.attr('href').substring(1)).offset().top-90
        }, 1500, 'easeInOutExpo');
...
$(window).on('scroll', function() {
 ...
 //             $(".newsletter").val('');
 //             $(".newsletter").attr('placeholder', 'Please write a proper email');

 //         } else {
 //             clickstate = 2;

 //             $(".newsletter").val('');
 //             $(".newsletter_btn_text", this).text("Save");
 //             $(".newsletter").attr('placeholder', 'Name');

 //         }
 //     } else {


 //         var nameNewsletter = $(".newsletter").val();

 //         if (nameNewsletter.length < 1) {

 //             $(".newsletter").attr('placeholder', 'Please write a proper name');

 //         } else {
 //             $(".newsletter").val('');
 //             $(".newsletter").attr('placeholder', 'Thanks for subscribing');
 //             $(".newsletter_btn_text", this).text("We'll be in touch ");
